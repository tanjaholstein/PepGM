...
Includes taxIDS not represented in the NCBI taxonomy database, to be added as --addTaxa
'''
...
TaxaNameDict.update({2697049001:'SARS-CoV-2 alpha',2697049002:'SARS-CoV-2 delta',2697049003:'SARS-CoV-2 omicron'})
